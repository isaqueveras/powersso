...
func (a *authSuite) TestShouldCreateUser() {
	var (
		err    error
		userID *uuid.UUID
		input  = &authentication.CreateAccount{
	...
	a.mock.ExpectBegin()
	a.mock.ExpectQuery(regexp.QuoteMeta(`INSERT INTO user (first_name,last_name,email,password) VALUES ($1,$2,$3,$4) RETURNING "id"`)).
